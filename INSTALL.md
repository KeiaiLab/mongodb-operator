...
> **BREAKING (ADR-0028 Phase D, 2026-05-17)**: OLM v0 cluster install path + community-operators upstream sync 자동화 영구 폐기. Path 3 (OLM v0) 챕터 제거. 외부 사용자는 *OLM v1 (Path 1)* 또는 *Helm (Path 2)* 사용. 자세한 내용은 [CHANGELOG.md](CHANGELOG.md) BREAKING CHANGES 섹션 + [ADR-0028](docs/kb/adr/0028-olm-external-user-production-readiness.md) Phase D 참조.
