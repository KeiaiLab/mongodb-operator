...
| You want a feature added or behaviour changed. | [Open an issue](https://github.com/keiailab/mongodb-operator/issues/new/choose) using the **Feature request** template. Check [ROADMAP.md](ROADMAP.md) first to see if it's already planned. |
