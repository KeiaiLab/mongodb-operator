...
| 您遇到 Prometheus 告警,需要 MTTR 操作流程。 | [`docs/operations/runbook.md`](docs/operations/runbook.md) §9 (每条告警的 `runbook_url` annotation 都指向此处)。 |
...
2. 尝试 [troubleshooting 流程图](docs/operations/troubleshooting.md)。
3. 在您的报告中准备好以下内容:
