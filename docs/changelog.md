...
- **artifacthub.io/operatorCapabilities 격상**: `Seamless Upgrades` (Level II) → `Deep Insights` (Level IV). issue #260 v7 실측 기반 — Level I-IV 100% 달성 (45/66 = 68%, Level V Auto Pilot 0/21 잔여). 누적 반영 PR: #238-#267.
...
- **README GA-ready**: Removed outdated v1.3.2-beta warning, all text English-first
- **Features expanded**: Authentication (SCRAM + X.509 + LDAP), monitoring (PrometheusRule + Grafana), network security
- **CODE_OF_CONDUCT**: Fixed placeholder contact email
- **CITATION.cff**: Version synced to v1.8.0

### Fixed

- Go badge version 1.25 → 1.26
- MongoDB badge 7.0 → 8.x
