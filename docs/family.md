...
You are reading this from the **`mongodb-operator`** repository. This page is the canonical cross-link for the entire family.
...
| Task | Entry point |
|---|---|
| Deploy `mongodb-operator` on Kubernetes | [README.md](../README.md) Quickstart section |
| Read the architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) |
| File an issue or feature request | https://github.com/keiailab/mongodb-operator/issues |
| Discuss design or roadmap | https://github.com/keiailab/mongodb-operator/discussions |
