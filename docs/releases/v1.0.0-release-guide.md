...
✅ **CHANGELOG.md**: v1.0.0 section added with comprehensive release notes
✅ **charts/mongodb-operator/Chart.yaml**: version and appVersion set to 1.0.0
✅ **Artifact Hub annotations**: updated with v1.0.0 changes
...
Build linux/amd64 Docker image and push to Docker Hub (RFC-0002 §2: amd64-only).
...
#### 4.2 Build Single-Platform Image

```bash
# Build and push linux/amd64 image (RFC-0002 §2: amd64-only)
docker buildx build \
...
git clone --branch gh-pages https://github.com/keiailab/mongodb-operator.git gh-pages-temp
cd gh-pages-temp
...
helm repo index . --url https://keiailab.github.io/mongodb-operator
...
curl -s https://keiailab.github.io/mongodb-operator/index.yaml | grep -A 5 "name: mongodb-operator" | head -20
...
- [README](https://github.com/keiailab/mongodb-operator#readme)
- [Documentation](https://github.com/keiailab/mongodb-operator/tree/main/docs)
- [Examples](https://github.com/keiailab/mongodb-operator/tree/main/examples)

## Artifacts

- Docker: \`keiailab/mongodb-operator:v1.0.0\`
...
1. Navigate to: https://github.com/keiailab/mongodb-operator/releases/new
...
```bash
# Pull and test
docker pull keiailab/mongodb-operator:v1.0.0
docker run --rm keiailab/mongodb-operator:v1.0.0 --version

# Verify linux/amd64 support (RFC-0002 §2)
docker buildx imagetools inspect keiailab/mongodb-operator:v1.0.0

# Verify latest tag
docker pull ghcr.io/keiailab/mongodb-operator:latest
docker run --rm ghcr.io/keiailab/mongodb-operator:latest --version
```
...
- Open: https://github.com/keiailab/mongodb-operator/releases/tag/v1.0.0
...
- ✅ Comprehensive CI/CD with 5 GitHub Actions workflows
- ✅ Production-ready documentation (9 guides)
- ✅ Tested examples (7 configurations)
- ✅ Security scanning and SBOM/Provenance
- ✅ Helm chart published to Helm repository
- ✅ Artifact Hub integration

See the [v1.0.0 release notes](https://github.com/keiailab/mongodb-operator/releases/tag/v1.0.0) for full details.
...
```
🎉 MongoDB Operator v1.0.0 - Initial Stable Release!
...
Learn more: https://github.com/keiailab/mongodb-operator/releases/tag/v1.0.0
...
# Enable QEMU (only required for cross-build from non-amd64 host)
...
helm repo index . --url https://keiailab.github.io/mongodb-operator --merge index.yaml
```
...
# Click "More actions" → "Check for updates"
```
...
| Docker build | 5-10 minutes | amd64-only |
...
- **GitHub Discussions**: https://github.com/keiailab/mongodb-operator/discussions
- **Documentation**: https://github.com/keiailab/mongodb-operator/tree/main/docs
...
- [Artifact Hub — Repositories](https://artifacthub.io/docs/topics/repositories/)
