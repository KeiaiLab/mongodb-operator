...
PVC auto-resize. valkey-operator PR #39 + postgres-operator PR #33 cross-operator
이식. StatefulSet.spec.volumeClaimTemplates 는 immutable 이므로 *기존 PVC 직접 patch*
...
// stsNames: ReplicaSet 1개 mongodb 의 경우 [mdb.Name] 단일 슬라이스.
func expandDataPVCs(
	ctx context.Context,
	c client.Client,
	namespace string,
